...
daysInMonth.updateValue(29, forKey: "Februray")
print(daysInMonth)
...
var shapesArray = ["Circle", "Rectangle", "Ellipse", "Triangle"]
var colorArray = ["Red", "Black", "White", "Blue"]
var newDictionary = Dictionary<String, [String]> ()
newDictionary["Shapes"] = shapesArray
newDictionary["Colors"] = colorArray
print(newDictionary)
...
if let lastElement = newDictionary["Colors"]?.last {
    print(lastElement)
}
/*:
