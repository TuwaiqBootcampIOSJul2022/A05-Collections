...
if let checkValue = numberOfDays.removeValue(forKey: "January") {
    print(checkValue)
    print("January has \(checkValue) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
var shapesArray : [String:[String]] = ["Shapes" : ["Circle" , "Triangle" , "Square"]]
var colorsArray : [String:[String]] = ["Colors" : ["Red" , "Yallow" , "Blue"]]
print(shapesArray ,colorsArray)
...
if let chooseColor = colorsArray["Colors"]
{
    print(chooseColor.last!)
}
