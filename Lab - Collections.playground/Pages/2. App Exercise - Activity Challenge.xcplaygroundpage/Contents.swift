 ...
 */
var  walkingChallenges  = ["Walk 3 miles a day","walk 100 miles per week"]
var runningChallenges  = ["Run 5 times a week", "Run 10 times per 2 weeks"]
...
//first element in the second challenge list
...
if userDid.isEmpty {
    print("Keep going commit your challnge")
}else{
