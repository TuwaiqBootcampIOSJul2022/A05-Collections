...
import Darwin
var walking :[String] = ["Walk 3 miles a day"," Walk 21 miles in one week" , ]
var running :[String] = ["Run 5 times a week" , "Run for 15 minutes for every day"]
