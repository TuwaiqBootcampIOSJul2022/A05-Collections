 ...
 */
var walkingChallenges : Array<String> = ["Walk 3 miles a day" , "Walk 15 miles a week"]
var runningChallenges : Array<String> = ["Run 5 times a week" , "Run 1 mile a day"]
var swimmingChallenges : [String] = ["Swim in 100 meters in 5 times" , "Diving for 10 minutes"]
...
challenges.append(walkingChallenges)
challenges.append(runningChallenges)
challenges.append(swimmingChallenges)
print(challenges)
...
if userChallenges .isEmpty {
    print("You aren't committed to a challenge, please commit")
    
}else if userChallenges.count == 1{
    print("The challenge you have chosen is: \(swimmingChallenges[1])")
}else{
