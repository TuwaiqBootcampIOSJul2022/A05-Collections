 ...
 */
var walkingChallenges = ["Walk 3 miles a day","Walk 10 Steps a day"]
var runningChallenges = ["Run 5 times a week","Run one hour a day"]
...
if committedChallenges.isEmpty == true
{
    print("Commit a challenge please!")
}
else
{
